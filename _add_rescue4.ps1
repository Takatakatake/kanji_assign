# 第4次救済: CSV2890 内の真ギャップ2件(ユーザー裁定 2026-06-20)。violon→琴(楽器系列。pian=琴基本形を奪わぬよう pejvo)・bronz→青铜(青/铜とも一级の透明2字熟語)。
...
$resc=@( @('violon','琴'), @('bronz','青铜') )   # 両者とも非PIV=pejvo band(楽器基本形 pian=basic は不変)
