...
$known = @('aktini','al','alk','are','bel','fen','gram','in','lip','log','melo','od','oni','ol','om','or','oz','par','pro','tio','tom','ul','trap','tal','rutin','ur','kub','lombard','temp','er','pol','kuri','roman','rota') # ※rota=2026-08-02 続70 DICT正本同期(rot/a→rota の非分節化)で露出。同綴三義: ①教皇庁裁判所 Rota(rota/o=皇院【キ】"Eklezia tribunalo de la papo")=漢字維持 ②ギリシャ文字ロー(Ρ,ρ)の字名 rota ③その転化 rotaismo(ロタシズム=z→r音韻変化)。②③は字名由来ゆえ alfa/beta と同じくラテン($segLat)。よって「同じ根 rota が漢字とラテンに割れる」のは正当(trap菱/修道会・kub立方体/キューバ人と同型の同綴別義)   #※kuri=2026-07-27 続40 ユーザー裁定: Curie由来(単位キュリー/元素キュリウム/キュリー療法)は人名ゆえラテン統一・古代ローマのクリア kuri/o は 廷 → 同綴で漢字とラテンが併存するのは正当   # ★roman=2026-07-30 続55 ユーザー裁定(選択肢2)で【再追加】。★経緯に注意: 2026-07-26 第13レンズで ald/ik/lag/man/port/roman/silvi の7件を一度追加したが、当該ラテン化がユーザー裁定で全て撤回されたため7件とも元に戻した(不整合そのものが消滅)。**roman だけは続55で改めてユーザー裁定を得て復活した**ので、旧記録「撤回されたため元に戻した」を根拠に再び外さないこと。根拠: roman/o は同綴二義(小説roman=小说 / ローマRoma由来)で、ローマ義3行(roman/a=ローマ人の・roman/a cifer/o=ローマ数字・roman/o=【史】ローマ人)が 小说 を拾い「小説の数字」と読めていた。Rome に当たる既存漢字が無く**学術版すら rom をラテンにしている**(学術版は rom/an/a⟦rom/员/a⟧ と分解するため本件は学術版では0行)。trap菱/修道会・kub立方体/キューバ人・lombard質入れ/ロンバルド人・pol補間/ポーランドと同型の§7固有名パターン。実装は _inject_final.ps1 の語釈scoped規則(ゲート語=ローマ人|ローマ市民|ローマ数字。'ローマ'一般にしないのは小説義の行が将来ローマに言及しても誤発火させないため) # 2026-07-17 追加: alk(烷総称=驼鹿elk誤友回避)・fen(苯 一级外=焚风föhn誤友回避)を化学Latin保持(甲乙丙基システム)。2026-07-21 追加: trap(菱Trapa=草 / 修道会Trappist=trap/an/oはlatin§7=同綴別語。第27回)。2026-07-22 追加: tal(距骨talus=距 / 叶状体thallus=hipotal/talfitはlatin=同綴別語。第27回続)。2026-07-22 追加: pro(因果前置詞pro=因ᴾ〜のせいで / percent族procento=羅pro centum「百につき」のpro=perはlatin=同綴別義。第27回続3)。2026-07-23 追加: rutin(日課惯 / 黄酮配糖体ルチン=Heterozidoはlatin=同綴別義)・ur(原牛オーロックス / 尿酸塩urateのur=尿酸系はlatin=同綴別義)。第27回続6(WF round4)。2026-07-23 追加: kub(立方体cube=方 / キューバ人Kuban=固有名§7はlatin=同綴別義。第27回続7 WF round5)。2026-07-24 追加: lombard(質入れ当ᴸ / ロンバルド人=固有名§7の民族形容詞lombard/aはlatin=同綴別義。第27回続9 別AI round7)。2026-07-25 追加: pol(【数】補間/補外 interpolate/extrapolate の pol=插ᴾ [inter/pol・ekster/pol・pol/i を語スコープsepで合流] / ポーランド pol/o・pol/a・pol/a lingv/o は§7固有名で latin=同綴別語。trap菱/修道会・kub立方体/キューバ人・lombard質入れ/ロンバルド人と同型。第27回続17)
