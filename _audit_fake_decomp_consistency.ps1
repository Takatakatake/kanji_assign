...
$known = @('aktini','al','alk','are','bel','fen','gram','in','lip','log','melo','od','oni','ol','om','or','oz','par','pro','tio','tom','ul','trap','tal','rutin','ur')   # 2026-07-17 追加: alk(烷総称=驼鹿elk誤友回避)・fen(苯 一级外=焚风föhn誤友回避)を化学Latin保持(甲乙丙基システム)。2026-07-21 追加: trap(菱Trapa=草 / 修道会Trappist=trap/an/oはlatin§7=同綴別語。第27回)。2026-07-22 追加: tal(距骨talus=距 / 叶状体thallus=hipotal/talfitはlatin=同綴別語。第27回続)。2026-07-22 追加: pro(因果前置詞pro=因ᴾ〜のせいで / percent族procento=羅pro centum「百につき」のpro=perはlatin=同綴別義。第27回続3)。2026-07-23 追加: rutin(日課惯 / 黄酮配糖体ルチン=Heterozidoはlatin=同綴別義)・ur(原牛オーロックス / 尿酸塩urateのur=尿酸系はlatin=同綴別義)。第27回続6(WF round4)
