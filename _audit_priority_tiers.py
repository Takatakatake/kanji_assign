...
# 2026-07-26 第27回続33(第12レンズ): 第8レンズのCSV2890照合是正(86.8%→96.9%)で新たに tier0 と判明した
#   2群 任(ajn任意 vs kapric気まぐれ)・员(接尾-an員 vs membr成員) を追加。いずれも既存47群と同型=
#   機能形態素(func/suf)が固有字を保持しCSV2890内容語が識別子付き衛星(ajn/a任・ajn/ul/o任/者 vs 任ᴷ /
#   -an员の派生 club/an/o等 vs 员ᴹ)。字は同一で識別子により区別=誤読なし。§5/§6確定機能層。
TIER0_KNOWN = {
